    ...
    <section className="relative bg-linear-to-br from-[#0a1628] via-[#1e293b] to-[#0f172a] text-white py-16 md:py-20 overflow-hidden min-h-[85vh] flex items-center">
      ...
      <div className="container mx-auto px-4 relative z-10 animate-fade-in">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-white/80 mb-10 max-w-2xl mx-auto delay-150 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center delay-300 mb-12">
            <Link to="/products">
              <Button
                size="lg"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto delay-500">
